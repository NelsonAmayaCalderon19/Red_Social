...
$mail = new PHPMailer();
	...
	$select_buscar=$con->prepare("
			SELECT * FROM persona as p, usuario as us WHERE us.Password='".$pass."' and us.Usuario=p.Usuario and  p.Email= :campo;"
		);
...
foreach ($resultado as $fila): {
	...
	$mail->Subject = 'Proceso de Recuperacion de Usuario';
	...
	<h1 style="color: red; font-family: times new roman; font-size: 25px; text-align: center; font-weight: bold;">Recuperación de Usuario</h1><h3 style="color: black; font-family:times new roman; font-size: 20px;"><b>Tu Usuario es:</b> ' . $Usuario .  '</h3></div><div contenteditable="false" style="text-align: center; margin: auto;
  position: relative;
  top: auto;
  width: 500px;
  height: 50px;
  ...
  font-size: 20px; font-family: verdana; padding-bottom: 8px;">2020 © All Rights Reserved. Desarrollado por:<br>Red Social</div>'; 
	...
	if($mail->send()){
		...
		header("Location: ../recuperar_user.php");
	}
?>