...
if (!isset($_SESSION["usuario"])) {
  header("location:index.php");
   ...
   ?>
<link rel="stylesheet" type="text/css" href="css/styles_seguidores.css">
</head>
<body onload="busqueda();">
<?php include "includes/header.php" ?>
           <a href="principal.php" style="text-decoration: none;" id="volver"><i class="fa fa-arrow-circle-left" aria-hidden="true" id="volver"></i></a>
...
$con = conexion();
$consulta = "SELECT  p.Imagen_Perfil, p.Usuario FROM seguidor as s, persona as p where p.Usuario=s.Usuario and s.Id_Estado='1' and s.Usuario_Seg='".$_SESSION["usuario"]."'";
...
<script src="javaScript/seguidores.js"></script>
</body>
</html>